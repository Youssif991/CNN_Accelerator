...
vlog -work work -timescale "1ns/1ps" "$SRC_PATH/control/pixel_source_mux.v"
vlog -work work -timescale "1ns/1ps" "$SRC_PATH/control/result_tag_pipeline.v"
...
vlog -work work -timescale "1ns/1ps" "$SRC_PATH/datapath/pix_col_calc.v"
vlog -work work -timescale "1ns/1ps" "$SRC_PATH/datapath/pixel_pad_inserter.v"
vlog -work work -timescale "1ns/1ps" "$SRC_PATH/datapath/result_field_unpack.v"

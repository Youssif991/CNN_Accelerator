...
create_clock -period 6.000 -name sys_clk_pin -waveform {0.000 3.000} -add [get_ports clk_i]
...
#set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports {led_1}];
